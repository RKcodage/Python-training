...
from PySide6.QtWidgets import QApplication, QLineEdit, QListWidget, QPushButton, QVBoxLayout, QWidget
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.le_task_title.setPlaceholderText("Tâche(s) à effectuer")
